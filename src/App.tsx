...
function App() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-red-400 via-pink-200 to-white">
      <audio
        ref={audioRef}
  
        src="/audio/Happy_anniversary.mp3"
        preload="auto"
      ...
      <div className="absolute inset-0 pointer-events-none">
        {[...Array(20)].map((_, i) => (
          ...
          >
            <Heart className="text-pink-500 w-6 h-6 transform rotate-45" />
          </div>
        ))}
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative mb-16">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 hidden md:flex flex-col gap-8 items-center animate-float-left">
              <Balloon className="w-12 h-12 text-green-500" />
              <Stars className="w-10 h-10 text-yellow-200" />
              <Party className="w-14 h-14 text-red-800" />
            ...
            <Balloon className="w-12 h-12 text-yellow-200" />
            <Stars className="w-10 h-10 text-green-500" />
              <Party className="w-14 h-14 text-red-800" />
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-red-800 via-pink-400 to-yellow-100 animate-spin-slow blur-xl opacity-75" 
     style={{ clipPath: "path('M50 15 C35 -10 0 0 0 40 C0 80 50 100 50 100 C50 100 100 80 100 40 C100 0 65 -10 50 15')" }}>
</div>
          ...
          {/* Message Section */}
          <div className="bg-gradient-to-t from-pink-400 to-pink-200 bg-opacity-80 rounded-xl p-8 mb-12 shadow-xl transform hover:scale-105 transition-transform duration-300">
            <p className="text-2xl text-gray-800 leading-relaxed ">
            Wishing you both a fantastic anniversary filled with love and good vibes! 💕
            </p>
          </div>
          ...
          {showSurprise && (
            <div className="mb-12">
              <div className="relative w-full  rounded-xl overflow-hidden shadow-2xl bg-gradient-to-r from-red-500 via-pink-400 to-pink-200 p-2">
